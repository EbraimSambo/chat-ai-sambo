...
const workspaces = ["Image", "Presentation", "Riset", "Image"];
    ...
    >
      ...
      {!collapsed && (
        <div className="px-3 mb-2">
          <p className="text-white/40 text-xs px-2 mb-1">Features</p>
          <NavItem icon={<MessageSquare size={15} />} label="Chat" active />
          <NavItem icon={<Archive size={15} />} label="Archived" />
          <NavItem icon={<BookOpen size={15} />} label="Library" />
        </div>
      )}
      ...
      {!collapsed && (
        <div className="px-3 flex-1">
          <p className="text-white/40 text-xs px-2 mb-1">Workspaces</p>
          <NavItem icon={<FolderPlus size={15} />} label="New Project" />
          {workspaces.map((w, i) => (
      ...
      {!collapsed && (
        <div className="m-3 p-3 rounded-xl bg-white/5 border border-white/10 text-center">
          ...
          <p className="text-white text-xs font-semibold mb-1">Upgrade to premium</p>
          <p className="text-white/40 text-[10px] mb-2">
            Boost productivity with seamless automation and responsive AI.
          </p>
